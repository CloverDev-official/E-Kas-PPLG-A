...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('murid')->insert([
            ...
            ['nipd' => '11109', 'nama_lengkap' => 'ANNISA MAULIDINA', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nipd' => '11112', 'nama_lengkap' => 'DINI', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nipd' => '11115', 'nama_lengkap' => 'GHAIDA ALTHAF FALIHA', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nipd' => '11119', 'nama_lengkap' => 'MEISYA RAIHANA PUTRI', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nipd' => '11132', 'nama_lengkap' => 'NABILLA APRILIA ASTIANY', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nipd' => '11134', 'nama_lengkap' => 'NORLIANA', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
            ['nipd' => '11135', 'nama_lengkap' => 'OLIVIA MARGARET', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nipd' => '11137', 'nama_lengkap' => 'RAISA LUTHFIA', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
            ...
            ['nipd' => '11139', 'nama_lengkap' => 'SAINA AMANDA PUTRI', 'password' => Hash::make('xipplga'), 'role' => 'siswi', 'jenis_kelamin' => 'P', 'created_at' => now(), 'updated_at' => now()],
