    ...
    <div
        ...
        <div class="p-8 md:p-16 flex gap-4 flex-col">
            ...
            <div class="flex flex-col gap-8 md:gap-16">
                <h1 class=" text-center font-heading font-semibold text-2xl md:text-4xl text-cardForeground pt-8 md:pt-0">Selamat datang di E-Kas
                </h1>
                <div class="leading-relaxed md:text-left text-center">
                    <h2 class="font-heading text-xl md:text-xl text-cardForeground font-medium">Masuk</h2>
                    <h3 class="font-label text-sm md:text-md font-reguler text-mutedForeground">Silahkan masukkan NIS dan Password
                        Anda</h3>
                </div>
            </div>

            <form wire:submit.prevent="login" class="mt-5 md:mt-10">
        ...
        <div class="hidden md:block">
            <img src="{{ asset('img/bg-login.png') }}" alt="Login Image" width="450">
        </div>
